<div id="footerWrap">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <p id="footer-copyright">
                    <?php if ($lang == 'en'): ?>
                        &copy; 2013 CARNIA DESIGN STUDIO. ALL RIGHTS RESERVED<br>
                        POWERED BY <a href="http://www.slimframework.com/">SLIM FRAMEWORK</a>
                    <?php endif ?>
                    <?php if ($lang == 'mk'): ?>
                        &copy; 2013 CARNIA DESIGN STUDIO. СИТЕ ПРАВА ЗАДРЖАНИ<br>
                        POWERED BY <a href="http://www.slimframework.com/">SLIM FRAMEWORK</a>
                    <?php endif ?>
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="social_icons" id="footer-social-icons"><!--
